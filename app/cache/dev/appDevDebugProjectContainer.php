...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\FindWorkerBundle\\Entity'))), 'FindWorkerBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('FindWorkerBundle' => 'FindWorkerBundle\\Entity'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\ApisBundle/Resources/views'), 'Apis');
        $instance->addPath(($this->targetDirs[3].'\\src\\FindWorkerBundle/Resources/views'), 'FindWorker');
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('559d46899f5a6')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'ApisBundle' => 'ApisBundle\\ApisBundle',
                'FindWorkerBundle' => 'FindWorkerBundle\\FindWorkerBundle',
